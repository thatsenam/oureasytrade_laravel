...
@section('content')
    ...
    <form action="/admin/withdraw-fund" enctype="multipart/form-data" method="POST">
        @csrf
        <div class="bg-gray-100 shadow rounded-lg p-6">
            <h2 class="h3 pb-4 font-bold ">Withdraw Details</h2>
            <div class="grid lg:grid-cols-2 gap-6">
                ...
                <div class="-mt-4 absolute tracking-wider px-1 uppercase text-xs">
                    <p>
                        <label for="username" class="bg-white text-gray-700 font-bold px-1">Previous withdraw *</label>
                    </p>
                </div>


                <p>
                    <input id="previous_withdraw_hidden" autocomplete="false" tabindex="0" type="number"
                        class="py-1 px-1 outline-none block h-full w-full" required value="0.0" disabled >
                    <input id="previous_withdraw" name="previous_withdraw"  tabindex="0" type="number"  value="0.0" hidden >
                </p>
            </div>
                ...
                <div
                    ...
                    <div class="-mt-4 absolute tracking-wider px-1 uppercase text-xs">
                        <p>
                            <label for="username" class="bg-white text-gray-700 font-bold px-1">Today's withdraw *</label>
                        </p>
                    </div>
                    ...
                    <p>
                        <input id="username" autocomplete="false" tabindex="0" type="number"
                            class="py-1 px-1 outline-none block h-full w-full" required value="20.0" name="withdraw">
                    </p>
                </div>
                <div
                class="border focus-within:border-blue-500 focus-within:text-blue-500 transition-all duration-500 relative rounded p-1">
        ...
        <div class="border-t mt-6 pt-3">
            <button id="submit" type="submit"
                ...
                Confirm withdraw <svg class="h-6 w-6 text-white inline" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor"><path d="M14 5l7 7m0 0l-7 7m7-7H3"></path></svg>
            </button>
